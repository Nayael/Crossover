package com.entity.engine 
{
	...
	public class SoundManager
	{
		...
		private var _position:Number	= 250;
		...
		static public function get instance():SoundManager {
			if (!_instance) _instance = new SoundManager( new SingletonLock() );			
			return _instance;			
		}		
		...
		public function playBGM( idx:int = BGM1, repeat:int = 999 ):void {
			...
			if ( s == null) {
				...
				_channelBGM.stop();
				if (_currentBGM != idx) { _position = 500 }; // effacer le point de sauvegarde si on switch
				_currentBGM = idx;
